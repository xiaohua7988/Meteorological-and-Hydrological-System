<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonitorStatus.aspx.cs" Inherits="WeatherStationMonitor.runStatuteStatistics.MonitorStatus" %>
...
<div id="page5_jAbsolutediv4" style="z-index: 800">
	<table id="page5_jTable1" class="table table-striped table-hover table-bordered">
		<tr align='center'>
            ...
            <td width="77" align='center'>及时率</td>
...
<div id="page5_jAbsolutediv1" style="z-index: 800">
	<div id="page5_jFormGroup1" class="form-group has-default col-md-12">
		...
		<select id="page5_jComboBox1" runat="server" name="page5_jComboBox1" class="form-control">
			...
			<option value="Q0009" >Q0009</option>
			<option value="Q0017">Q0017</option>
			<option value="Q0029">Q0029</option>
			<option value="Q0043">Q0043</option>
			<option value="U0015">U0015</option>
			<option value="U0058">U0058</option>
			<option value="U0062">U0062</option>
			<option value="U0007">U0007</option>
		</select>
	</div>
</div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="windGraph.aspx.cs" Inherits="WeatherStationMonitor.dataChart4.windGraph" %>
...
<div id="page1_jAbsolutediv1" style="z-index: 800">
	<div id="page1_jFormGroup1" class="form-group has-default">
		...
		<input id="page1_jEdit1" name="page1_jEdit1" type="text" class="form-control" placeholder="请选择日期" runat="server">
	</div>
</div>
